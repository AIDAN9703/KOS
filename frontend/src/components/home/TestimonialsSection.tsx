...
export default function TestimonialsSection() {
  ...
  return (
    <section className="relative py-24 bg-white dark:bg-gray-900 overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0 bg-[url('/patterns/testimonials-bg.svg')] opacity-5" />
      <div className="absolute inset-y-0 left-0 w-1/2 bg-gradient-to-r from-[#21336a]/10 to-transparent" />
      <div className="absolute inset-y-0 right-0 w-1/2 bg-gradient-to-l from-[#21336a]/10 to-transparent" />
